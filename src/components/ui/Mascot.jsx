...
const EMOTIONS = {
    ...
    serious: { eyes: { y: 0, scale: 1, pupilSize: 0.7 }, mouth: { d: "M 45 55 Q 50 55 55 55", strokeWidth: 3 }, lids: { d1: "M 25 45 L 38 48", d2: "M 62 48 L 75 45", opacity: 1 }, color: "#0284c7", scleroticaClip: CIRCLE_EYE },
    ...
    unimpressed: { eyes: { y: 1, scale: 1, pupilSize: 0.8 }, mouth: { d: "M 47 58 Q 50 54 53 58", strokeWidth: 3 }, lids: { d1: "M 23 45 Q 30 42 37 45", d2: "M 63 45 Q 70 42 77 45", opacity: 1 }, color: "#0284c7", scleroticaClip: "M -12 0 L 12 0 Q 12 12 0 12 Q -12 12 -12 0 Z" },
    stare: { eyes: { y: 0, scale: 0.9, pupilSize: 0.4 }, mouth: { d: "M 48 55 L 52 55", strokeWidth: 2 }, lids: { d1: "M 20 40 L 40 50", d2: "M 60 50 L 80 40", opacity: 1 }, color: "#1e3a8a", scleroticaClip: "M -11 2 L 11 2 L 11 -2 L -11 -2 Z" },
